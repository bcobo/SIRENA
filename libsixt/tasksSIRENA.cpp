...
{       
    ...
    {	
        ...
        {
            pulsetemplateMaxLengthFixedFilter = gsl_vector_alloc((*reconstruct_init)->post_max_value+(*reconstruct_init)->preBuffer_max_value);
            pulsetemplate = gsl_vector_alloc((*reconstruct_init)->post_max_value+(*reconstruct_init)->preBuffer_max_value);
        }
...
gsl_vector_memcpy(recordDERIVATIVE,record);*/
    ...
    for (int i=0;i<numPulses;i++)
    {
        ...
        else        
        {
            ...
            {
                if ((foundPulses->pulses_detected[i].pulse_adc_preBuffer = gsl_vector_alloc(foundPulses->pulses_detected[i].pulse_duration+(*reconstruct_init)->preBuffer_max_value)) == 0)
                {
                    sprintf(valERROR,"%d",__LINE__-2);
                    string str(valERROR);
                    message = "Allocating with <= 0 size in line " + str + " (" + __FILE__ + ")";
            ...
            else if ((*reconstruct_init)->preBuffer == 1)
            {
                if ((*reconstruct_init)->opmode == 0)
                {
                    ...
                    {
                        temp = gsl_vector_subvector(recordNOTFILTERED,gsl_vector_get(tstartgsl,i)-(*reconstruct_init)->preBuffer_max_value,foundPulses->pulses_detected[i].pulse_duration+(*reconstruct_init)->preBuffer_max_value);
                    }
...
int calculateTemplate(ReconstructInitSIRENA *reconstruct_init, PulsesCollection *pulsesAll, PulsesCollection *pulsesInRecord, double samprate, gsl_vector **pulseaverage, double *pulseaverageHeight, gsl_matrix **covariance, gsl_matrix **weight, gsl_vector **pulseaverageMaxLengthFixedFilter)
{
    ...
    else if (reconstruct_init->preBuffer == 1)
    {
        ...
        pulseLengthCT = reconstruct_init->post_max_value + preBuffer_value;
    }
    ...
    *pulseaverageHeight = *pulseaverageHeight/nonpileupPulses;
    ...
    //    cout<<i<<" "<<gsl_vector_get(*pulseaverage,i)<<endl;
...
int writeLibrary(ReconstructInitSIRENA **reconstruct_init, double samprate, double estenergy, gsl_vector *pulsetemplate, gsl_matrix *covariance, gsl_matrix *weight, bool appendToLibrary, fitsfile **inLibObject, gsl_vector *pulsetemplateMaxLengthFixedFilter)
{
    ...
    else	// Write the first row of the library
    {
        ...
        if ((*reconstruct_init)->preBuffer == 1)
        {
            pulsetemplates_matrix = gsl_matrix_alloc(1,(*reconstruct_init)->post_max_value+(*reconstruct_init)->preBuffer_max_value);
            pulsetemplatesMaxLengthFixedFilters_matrix = gsl_matrix_alloc(1,(*reconstruct_init)->post_max_value+(*reconstruct_init)->preBuffer_max_value);
            pulsetemplatesb0_matrix = gsl_matrix_alloc(1,(*reconstruct_init)->post_max_value+(*reconstruct_init)->preBuffer_max_value);
            matchedfilters_matrix = gsl_matrix_alloc(1,(*reconstruct_init)->post_max_value+(*reconstruct_init)->preBuffer_max_value);
            matchedfiltersb0_matrix = gsl_matrix_alloc(1,(*reconstruct_init)->post_max_value+(*reconstruct_init)->preBuffer_max_value);
        }
        else
        {
...
{ 
    ...
    {
        matchedfilters_row = gsl_vector_alloc(reconstruct_init->post_max_value+reconstruct_init->preBuffer_max_value);
    }
...
{	  
    ...
    {
        modelsMaxLengthFixedFilteraux = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        modelsaux = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        modelsb0aux = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        matchedfiltersaux = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        matchedfiltersb0aux = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        weightaux = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        covarianceaux = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        Pabaux = gsl_matrix_alloc(eventcntLib+1, reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        PabMaxLengthFixedFilteraux = gsl_matrix_alloc(eventcntLib+1, reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        Dabaux = gsl_matrix_alloc(eventcntLib+1, reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
    }
    ...
    {
        vectoraux1 = gsl_vector_alloc(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
    }
    ...
    {
        modelsMaxLengthFixedFilterrow = gsl_vector_alloc(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        modelsMaxLengthFixedFilteraux1 = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        modelsrow = gsl_vector_alloc(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        modelsaux1 = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        modelsrowb0 = gsl_vector_alloc(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        modelsb0aux1 = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        matchedfiltersrow = gsl_vector_alloc(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        matchedfiltersaux1 = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        matchedfiltersrowb0 = gsl_vector_alloc(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        matchedfiltersb0aux1 = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        
        weightaux1 = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        covarianceaux1 = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        
        Pabaux1 = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        PabMaxLengthFixedFilterrow = gsl_vector_alloc(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        PabMaxLengthFixedFilteraux1 = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        Pabrow = gsl_vector_alloc(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        Dabrow = gsl_vector_alloc(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        Dabaux1 = gsl_matrix_alloc(eventcntLib+1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
    }
    ...
    {
        matrixaux = gsl_matrix_alloc(1,reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        matrixaux2 = gsl_matrix_alloc(1,(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value)*(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value));
        matrixaux_2 = gsl_matrix_alloc(1,(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value)*2);
    }
...
{		
    ...
    {
        Pab = gsl_vector_alloc(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        PabMaxLengthFixedFilter = gsl_vector_alloc(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        Dab = gsl_vector_alloc(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        DabMaxLengthFixedFilter = gsl_vector_alloc(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        vectoraux1 = gsl_vector_alloc(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
        vectorMaxLengthFixedFilteraux1 = gsl_vector_alloc(reconstruct_init->preBuffer_max_value+reconstruct_init->post_max_value);
    }
...
int obtainRiseFallTimes (gsl_vector *recordNOTFILTERED, double samprate, gsl_vector *tstartgsl, gsl_vector *tendgsl, gsl_vector *Bgsl, gsl_vector *Lbgsl, int numPulses, gsl_vector **tauRisegsl, gsl_vector **tauFallgsl)
{
    ...
    for (int i=0;i<numPulses;i++)
    {
        ...
        //cout<<"gsl_vector_get(tendgsl,i): "<<gsl_vector_get(tendgsl,i)<<endl;
        temp = gsl_vector_subvector(recordNOTFILTERED,gsl_vector_get(tstartgsl,i),gsl_vector_get(tendgsl,i)-gsl_vector_get(tstartgsl,i));
        amax = gsl_vector_max(&temp.vector);
 ...
 *               by taking into account the info read from the XML file and the 'OFStrategy' (FREE, BYGRADE or FIXED).
 *
 * Parameters:
 * - reconstruct_init: Member of 'ReconstructInitSIRENA' structure to initialize the reconstruction parameters (pointer and values).
...
int pulseGrading (ReconstructInitSIRENA *reconstruct_init, int grade1, int grade2, int OFlength_strategy, int *pulseGrade, long *OFlength)
{
    ...
    /*int vhigh = gsl_matrix_get(reconstruct_init->grading->gradeData,0,1);	// 'gradelim_post' if 'value'(grading num) = 1
    int high = gsl_matrix_get(reconstruct_init->grading->gradeData,1,1);	// 'gradelim_post' if 'value'(grading num) = 2
    int inter = gsl_matrix_get(reconstruct_init->grading->gradeData,2,1);	// 'gradelim_post' if 'value'(grading num) = 3
    int mid = gsl_matrix_get(reconstruct_init->grading->gradeData,3,1);	// 'gradelim_post' if 'value'(grading num) = 4
    int lim = gsl_matrix_get(reconstruct_init->grading->gradeData,4,1);	// 'gradelim_post' if 'value'(grading num) = 5
    int low = gsl_matrix_get(reconstruct_init->grading->gradeData,5,1);	// 'gradelim_post' if 'value'(grading num) = 6*/
    ...
    /*if (grade1 >= vhigh)	// Very High res
    {
        *pulseGrade = 1;	
        if (OFlength_strategy == 2) 	*OFlength = vhigh;
    }
    else if (grade1 >= high)	// High res
    {
        *pulseGrade = 2;
        if (OFlength_strategy == 2)	*OFlength = high;	
    }
    else if (grade1 >= inter)	// Inter res
    {
        *pulseGrade = 3;
        if (OFlength_strategy == 2)	*OFlength = inter;
    }
    else if (grade1 > mid)	// Mid res
    {
        *pulseGrade = 4;
        if (OFlength_strategy == 2) 	*OFlength = mid;
    }
    else if (grade1 > lim)	// Lim res
    {
        *pulseGrade = 5;
        if (OFlength_strategy == 2) 	*OFlength = lim;
    }
    else if (grade1 > low)	// Low res
    {
        *pulseGrade = 6;
        if (OFlength_strategy == 2) 	*OFlength = low;
    }
    else if (grade1 <= low)	//Pileup
    {
        *pulseGrade = -2;
        if (OFlength_strategy == 2) 	*OFlength = grade1; 
    }*/
    ...
    *pulseGrade = 0;
    for (int i=0;i<reconstruct_init->grading->ngrades;i++)
    {
        if (grade1 >= gsl_matrix_get(reconstruct_init->grading->gradeData,i,1))
        {
            *pulseGrade = i+1;
            if (OFlength_strategy == 2) 	*OFlength = gsl_matrix_get(reconstruct_init->grading->gradeData,i,1);
            break;
        }
    }
    if (*pulseGrade == 0)
