...
{
        //cout<<filter->size<<"reconstruct_init->nLags: "<<reconstruct_init->nLags<<endl;
        string message = "";
	char valERROR[256];
                                                ...
                                                {   
                                                    ...
                                                    if ((xmax < -1) || (xmax > 1))
                                                    {
                                                        ...
                                                        {  
                                                            ...
                                                            //cout<<"lAGS_vector: "<<gsl_vector_get(lags_vector,1)<<*" "<<gsl_vector_ge*t(calculatedEnergy_vector,1)<<endl;
